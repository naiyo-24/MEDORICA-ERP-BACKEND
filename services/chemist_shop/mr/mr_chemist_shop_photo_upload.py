...
# Compress, rename and store chemist shop photo under uploads/chemist_shops/mr/{shop_id}/.
def save_mr_chemist_shop_photo(upload_file: UploadFile, shop_id: str, shop_name: str) -> str:
	base_dir = os.path.join("uploads", "chemist_shops", "mr", shop_id)
...
# Compress, rename and store chemist shop bank passbook photo under uploads/chemist_shops/mr/{shop_id}/.
def save_mr_chemist_shop_bank_passbook_photo(upload_file: UploadFile, shop_id: str, shop_name: str) -> str:
	base_dir = os.path.join("uploads", "chemist_shops", "mr", shop_id)
	os.makedirs(base_dir, exist_ok=True)
...
def delete_mr_chemist_shop_assets(shop_id: str) -> None:
	base_dir = os.path.join("uploads", "chemist_shops", "mr", shop_id)
