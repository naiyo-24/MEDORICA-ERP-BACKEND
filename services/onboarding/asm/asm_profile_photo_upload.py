...
def _sanitize_filename(value: str) -> str:
	...
	return cleaned.strip("_") or "asm"


# Compress, rename and store the uploaded profile photo for an ASM.
def save_asm_profile_photo(upload_file: UploadFile, asm_id: str, full_name: str) -> str:
	os.makedirs("uploads", exist_ok=True)
	base_dir = os.path.join("uploads", "asm", asm_id)
...
# Delete profile photo assets for an ASM.
def delete_asm_profile_assets(asm_id: str) -> None:
	base_dir = os.path.join("uploads", "asm", asm_id)
