...
# Store chemist shop network details managed by an MR.
class MRChemistShopNetwork(Base):
	__tablename__ = "mr_chemist_shop_network"
	__table_args__ = (
		UniqueConstraint("mr_id", "phone_no", name="uq_mr_chemist_shop_phone"),
	)
