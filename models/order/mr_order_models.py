...
# Store order details created by an MR with optional links to distributor, chemist shop and doctor.
class MROrder(Base):
    __tablename__ = "mr_order"
    ...
    chemist_shop_id = Column(String(64), ForeignKey("mr_chemist_shop_network.shop_id"), nullable=True, index=True)
    doctor_id = Column(String(64), ForeignKey("mr_doctor_network.doctor_id"), nullable=True, index=True)
